# bolbhiduback/bolbhiduback/settings.py
# This file configures the Django project settings.
...
ROOT_URLCONF = 'bolbhiduback.urls'
...
WSGI_APPLICATION = 'bolbhiduback.wsgi.application'
